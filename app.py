...
def ver_mapa():
    ...
    tiendas = [
        {'nombre': 'Doña Filomena', 'contacto': 'Filomena Delgado', 'direccion': 'Calle La Tablada #4533',
         'telefono': '77788899', 'pedido': '1001', 'foto': 'tienda_barrio.jpg', 'ubicacion': [-17.3935, -66.1570]},
        {'nombre': 'Abarrotes El Carmen', 'contacto': 'Carmen Rojas', 'direccion': 'Av. Blanco Galindo Km 2',
         'telefono': '70351210', 'pedido': '1002', 'foto': 'tienda_carmen.jpg', 'ubicacion': [-17.3850, -66.1700]},
        {'nombre': 'Minimarket Los Andes', 'contacto': 'Juan Mamani', 'direccion': 'Av. América Este #345',
         'telefono': '70707070', 'pedido': '1002', 'foto': 'tienda_andes.jpg', 'ubicacion': [-17.3980, -66.1420]},
        {'nombre': 'Tienda Don Pedro', 'contacto': 'Pedro Flores', 'direccion': 'Calle Jordán #1234',
         'telefono': '71234567', 'pedido': '1003', 'foto': 'tienda_pedro.jpg', 'ubicacion': [-17.4050, -66.1610]},
        {'nombre': 'Mercadito Central', 'contacto': 'María Gutiérrez', 'direccion': 'Av. Ayacucho #887',
         'telefono': '78901234', 'pedido': '1004', 'foto': 'tienda_central.jpg', 'ubicacion': [-17.3925, -66.1480]},
        {'nombre': 'Almacén El Sol', 'contacto': 'Roberto Mendoza', 'direccion': 'Av. Heroínas #765',
         'telefono': '76767676', 'pedido': '1005', 'foto': 'tienda_sol.jpg', 'ubicacion': [-17.3880, -66.1550]},
        {'nombre': 'Tienda Doña Rosa', 'contacto': 'Rosa Méndez', 'direccion': 'Calle Hamiraya #432',
         'telefono': '79876543', 'pedido': '1006', 'foto': 'tienda_rosa.jpg', 'ubicacion': [-17.4010, -66.1520]}
    ]
    ...
    for tienda in tiendas:
        ...
        <tr><td colspan="2" style='color:white;'><center><a class='btn btn-primary' href='/pedido'>Ver Pedido</a></center></td></tr>
        </table>
        """
        folium.Marker(
...
def buscar_pedido():
    ...
    return render_template('pedido.html', pedido=pedido, error=error, success=success, total=total, pedidos_ejemplo=True)
...
def actualizar_pedido():
    ...
    if numero_pedido not in PEDIDOS_DB:
        return render_template('pedido.html', error="Pedido no encontrado.")
    ...
    try:
        ...
        return render_template('pedido.html', pedido=pedido, success=success, total=total)

    except (ValueError, TypeError) as e:
        return render_template('pedido.html', pedido=pedido, error=f"Error al actualizar: {str(e)}",
                               total=sum(art['cantidad'] * art['precio'] for art in pedido['articulos']))
...
def buscar_cliente():
    ...
    return render_template('preventa.html', codigo=codigo, error=error, success=success, total=total, clientes_ejemplo=True)
